...
Popular software solutions such as G\*power require participants to enter their predictions as Cohen's f or partial eta squared ($\eta_p^2$), which are not the most intuitive way to specify a hypothesized pattern of results, and do not generalize to different experimental designs. Here, we demonstrate how to perform power analyses for factorial ANOVA designs based on simulations. 
