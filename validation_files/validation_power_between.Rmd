...
#0.06104044
#10.000 sims 
#run for control cat 39.48
#run for control dog 51.18
#run cat dog 6.21
#run for control cat 39.90
#run for control dog 52.25
#run cat dog 6.07
```
...
This analysis tells us that running the study with 50 participants in each condition is more likely to *not* yield a significant test result, even if our expected pattern of differences is true, that that we will observe a *p*-value smaller than our alpha level. This is not optimal. 
