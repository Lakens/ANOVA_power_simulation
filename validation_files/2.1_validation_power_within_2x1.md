...
```
    ...
    ##             power effect size
    ## anova_speed    83      0.2012
    ## 
    ## Power and Effect sizes for contrasts
    ##                         power effect size
    ## p_speed_fast_speed_slow    83      0.5036
...
```
    ...
    ## Power and Effect sizes for ANOVA tests
    ##             power effect size
    ## anova_speed    85      0.3133
    ## 
    ## Power and Effect sizes for contrasts
    ##                         power effect size
    ## p_speed_fast_speed_slow    85      0.6921
