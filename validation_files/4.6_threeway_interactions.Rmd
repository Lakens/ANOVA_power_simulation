...
Let's start with a 2x2x2 design with two between factors and one within factor. We collect 50 participants in the between participant conditions (so 200 participants in total). 

```{r}
string <- "2b*2b*2w"
n <- 50
#mu <- c(1, 1, 3, 1, 3, 3, 1, 3) 
mu <- c(1, 1, 1, 1, 1, 1, 1, 1) 
sd <- 5
r <- 0.5 
p_adjust = "none"
labelnames <- c("Size", "big", "small", "Color", "green", "red", "CognitiveLoad", "present", "absent") #
